...
static struct file_operations VENC_FOPS =
{
	...
	.compat_ioctl   = VENC_DRV_Ioctl,  //\D3û\A7̬ \A3\AC\C4ں\CB̬ƽ̨λ\BF\ED\B2\BBһ\D6µ\C4ʱ\BA򣬻\E1\B5\F7\D3\C3
...
static HI_S32 VENC_DRV_SetupCdev(VENC_ENTRY *venc, const struct file_operations *fops)
{
	...
	/*\D4\DA/sys/class/Ŀ¼\CF´\B4\BD\A8\C9豸\C0\E0\B1\F0Ŀ¼hi_venc*/
	...
	/*\D4\DA/dev/Ŀ¼\BA\CD/sys/class/hi_vencĿ¼\CF·ֱ𴴽\A8\C9豸\CEļ\FEhi_venc*/
...
static HI_S32 VENC_DRV_CleanupCdev(VENC_ENTRY *venc)
{
	/*\CF\FA\BB\D9\C9豸\C0\E0\B1\F0\BA\CD\C9豸*/
	if (venc->venc_class) {
