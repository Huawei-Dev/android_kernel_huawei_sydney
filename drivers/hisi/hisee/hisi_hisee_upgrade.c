...
/*************************************************************
??????????int first_check_newest_cosimage(unsigned int cos_id,
											 const cosimage_version_info *curr_ptr,
											 const cosimage_version_info *previous_ptr)
??????????????cos_id??????cos??????????????????????????????cos????(????cos??????NV counter??????????????????)
??????
??????cos_id:????cos??????id??curr_ptr:??????????????????hisee_img??????cos??????NV counter??????????????????????????????
		previous_ptr:??????????????????hisee_img??????cos??????NV counter????????????????????????????
??????????
????????HISEE_TRUE:????cos_id??????cos??????????????HISEE_FALSE:????cos_id??????cos????????????
?????????? ??
?????????? ??
*************************************************************/
...
??????????????cos_id??img_type????hisee_img??????cos????????????cos??????????????????cos_id??0,1,2??
		  ??cos??????????????HISEE RPMB????????????????cos??????????????????hisee????
??????
??????cos_id:????cos????id??img_type:????cos??????image type??
??????????
????????HISEE_OK:cos????????????????HISEE_OK:cos????????????
??????????????cos????????????????????
?????????? ??
*************************************************************/
int cos_upgrade_image_read(unsigned int cos_id, hisee_img_file_type img_type)
...
/*************************************************************
??????????int cos_image_upgrade_basic_process(void *buf, int para,
							unsigned int cos_id, hisee_img_file_type img_type)
??????????????cos_id????cos????????????????????????????????????hisee_img????????1K????????????????
		  ??????????retry??????????????????
??????
??????cos_id:????cos????id??buf:??????????????buffer??
	  para:??????????????????????????????????img_type:????cos??????image type??
??????????
????????HISEE_OK:cos????????????????HISEE_OK:cos????????????
??????????????cos????????????????????,????hisee_img????????????hisee.img????
??????????????????hisee??????????
*************************************************************/
