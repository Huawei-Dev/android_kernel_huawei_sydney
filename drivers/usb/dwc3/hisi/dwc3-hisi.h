 ...
 */
#define USBOTG3_CTRL0		0x00		/* ??????????????0 */
#define USBOTG3_CTRL1		0x04		/* ??????????????1 */
#define USBOTG3_CTRL2		0x08		/* ??????????????2 */
#define USBOTG3_CTRL3		0x0C		/* ??????????????3 */
#define USBOTG3_CTRL4		0x10		/* ??????????????4 */
#define USBOTG3_CTRL5		0x14		/* ??????????????5 */
#define USBOTG3_CTRL6		0x18		/* ??????????????6 */
#define USBOTG3_CTRL7		0x1C		/* ??????????????7 */
#define USBOTG3_STS0		0x20		/* ??????????0 */
#define USBOTG3_STS1		0x24		/* ??????????1 */
#define USBOTG3_STS2		0x28		/* ??????????2 */
#define USBOTG3_STS3		0x2C		/* ??????????3 */
#define BC_CTRL0		0x30		/* BC????????????0 */
#define BC_CTRL1		0x34		/* BC????????????1 */
#define BC_CTRL2		0x38		/* BC????????????2 */
#define BC_STS0			0x3C		/* BC??????????0 */
#define RAM_CTRL		0x40		/* RAM?????????? */
#define USBOTG3_STS4		0x44		/* ??????????4 */
#define USB3PHY_CTRL		0x48		/* PHY?????????? */
#define USB3PHY_STS		0x4C		/* PHY?????????? */
#define USB3PHY_CR_STS		0x50		/* PHY?????????????? */
#define USB3PHY_CR_CTRL		0x54		/* PHY?????????????? */
#define USB3_RES		0x58		/* USB?????????? */
