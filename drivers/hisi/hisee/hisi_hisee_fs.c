...
/*************************************************************
??????????int hisee_atoi(const char *str)
????????????????libc??atoi????????????????????????????????????????????
??????
??????str:??????????????????????
??????????
????????HISEE_U32_MAX_VALUE:????????????HISEE_U32_MAX_VALUE:??????????????
??????????????
?????????? ??
*************************************************************/
...
/*************************************************************
??????????int parse_misc_id_from_name(const img_file_info *curr_file_info,
									unsigned int *misc_image_cnt_array)
??????????????hisee.img????????????????????????misc??????misc id
??????
??????curr_file_info:????????????????????????????????????????
	 misc_image_cnt_array:????????????cos??????????misc??????????????????????
??????????
????????HISEE_OK:??????????????????HISEE_OK:????????????
??????????????
?????????? ????
...
??????
??????filename:??????cos??????????
??????buffer:??????????????????????buffer??file_size:????cos????????????????????????????
????????HISEE_OK:??????????????????????????????HISEE_OK:????
??????????????encos??????????????cos_flash??????????cos_flash??????????????max_read_size????
?????????? ??
*************************************************************/
int filesys_read_img_from_file(const char *filename, char *buffer, size_t *file_size, size_t max_read_size)
{
