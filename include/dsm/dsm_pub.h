...
#define DSM_BATTERY_ASW_PROTECT_H1_SCENE          (DSM_BATTERY_ERROR_NO_BASE + 96)
#define DSM_BATTERY_ASW_PROTECT_H2_SCENE          (DSM_BATTERY_ERROR_NO_BASE + 97)
#define DSM_BATTERY_ASW_PROTECT_NORMAL_SCENE      (DSM_BATTERY_ERROR_NO_BASE + 98)
